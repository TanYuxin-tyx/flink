 ...
 */
@PublicEvolving
public class DataFinishTrigger extends Trigger<Object, GlobalWindow> {
    private static final long serialVersionUID = 1L;

    private DataFinishTrigger() {}
    ...
    public static DataFinishTrigger create() {
        return new DataFinishTrigger();
    }
}
