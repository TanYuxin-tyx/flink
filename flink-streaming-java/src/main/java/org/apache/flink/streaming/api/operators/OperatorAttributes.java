...
public class OperatorAttributes {
    ...
    private final boolean outputOnCheckpoint;
    private final boolean internalSorterSupported;

    public OperatorAttributes(
            boolean isOutputOnEOF, boolean outputOnCheckpoint, boolean internalSorterSupported) {
     ...
     *
     * <ul>
     *   <li>The results of this operator as well as its upstream operators have blocking partition
     *       type.
