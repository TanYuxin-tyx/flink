...
public class OperatorAttributesBuilder {
    ...
    public OperatorAttributesBuilder setOutputOnCheckpoint(boolean outputOnCheckpoint) {
        this.outputOnCheckpoint = outputOnCheckpoint;
        return this;
    }
     ...
     *   <li>outputOnCheckpoint defaults to false
    ...
    public OperatorAttributes build() {
        ...
        if (outputOnCheckpoint == null) {
            LOG.debug(
                    "OperatorAttributes outputOnCheckpoint is null, set to the default value of false.");
            outputOnCheckpoint = false;
        }
        ...
        return new OperatorAttributes(outputOnEOF, outputOnCheckpoint, internalSorterSupported);
    }
}
