 ...
 */
public class FileDataIndexCache<T extends FileRegionManager.Region> {
    /**
     * This struct stores all in memory {@link FileRegionManager.Region}s. Each element is a treeMap
     * contains all in memory {@link FileRegionManager.Region}'s of specific subpartition
     * corresponding to the subscript. The value of this treeMap is a {@link
     * FileRegionManager.Region}, and the key is firstBufferIndex of this region. Only cached in
     * memory region will be put to here.
     */
