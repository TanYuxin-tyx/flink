 ...
 * </pre>
 */
public class FileDataIndexSpilledRegionManagerImpl<T extends FileRegionManager.Region>
    ...
    private final FileRegionManager<T> fileRegionManager;
    ...
    public FileDataIndexSpilledRegionManagerImpl(
            ...
            FileRegionManager<T> fileRegionManager) {
        try {
            this.channel =
                    FileChannel.open(
                            indexFilePath,
        ...
        this.fileRegionManager = fileRegionManager;
    ...
    private void writeRegionToOffset(long offset, T region) throws IOException {
        ...
        fileRegionManager.writeRegionToFile(channel, region);
    }
    ...
    private List<Tuple2<T, Long>> readRegionGroup(long offset, int numRegions) throws IOException {
        ...
        for (int i = 0; i < numRegions; i++) {
            T region = fileRegionManager.readRegionFromFile(channel, offset);
    ...
    public static class Factory<T extends FileRegionManager.Region>
