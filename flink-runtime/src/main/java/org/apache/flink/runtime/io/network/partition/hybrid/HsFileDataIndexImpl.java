...
import org.apache.flink.runtime.io.network.partition.hybrid.region.FileDataIndexCache;
import org.apache.flink.runtime.io.network.partition.hybrid.region.FileDataIndexSpilledRegionManagerImpl;
...
public class HsFileDataIndexImpl implements HsFileDataIndex {
        ...
        this.indexCache =
                new FileDataIndexCache<>(
                        ...
                        new FileDataIndexSpilledRegionManagerImpl.Factory<>(
                                ...
                                HsFileRegionManagerImpl.INSTANCE));
    }
    ...
    /**
     * A {@link InternalRegion} is an implementation of {@link FileRegionManager.Region}. Note that
     * this class introduced a new field to indicate whether each buffer in the region is released.
     */
    public static class InternalRegion implements FileRegionManager.Region {
        /**
    ...
    /**
     * The implementation of {@link FileRegionManager} to writing a region to the file or reading a
     ...
     */
    public static class HsFileRegionManagerImpl<T extends FileRegionManager.Region>
        ...
        public static final FileRegionManager<InternalRegion> INSTANCE =
                new HsFileRegionManagerImpl<>();

        private HsFileRegionManagerImpl() {}

        @Override
        public void writeRegionToFile(FileChannel channel, T region) throws IOException {
            HsRegionWriteReadUtils.writeHsInternalRegionToFile(
                    channel, regionHeaderBuffer, (InternalRegion) region);
        }

        @Override
        public T readRegionFromFile(FileChannel channel, long fileOffset) throws IOException {
            return (T)
