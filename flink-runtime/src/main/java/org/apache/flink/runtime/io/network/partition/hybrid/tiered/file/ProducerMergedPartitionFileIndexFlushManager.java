...
public class ProducerMergedPartitionFileIndexFlushManager {
    ...
    //                    ProducerMergedPartitionFileIndex.FixedSizeRegion.REGION_SIZE);
    //
    //    /**
    ...
    //     * ProducerMergedPartitionFileIndexFlushManager.SegmentMeta}, and the key is
    // minBufferIndex of
    //     * this segment. Only finished(i.e. no longer appended) segment will be put to here.
    //     */
    //    private final List<TreeMap<Integer,
    // ProducerMergedPartitionFileIndexFlushManager.SegmentMeta>>
    ...
    //    private final ProducerMergedPartitionFileIndexFlushManager.SegmentMeta[]
    // currentSegmentMeta;
    //
    //    /**
    ...
    //
    //    /**
    //     * This consumer is used to load region to cache. The first parameter is subpartition id,
    // and
    //     * second parameter is the region to load.
    //     */
    //    private final BiConsumer<Integer, ProducerMergedPartitionFileIndex.Region>
    // cacheRegionConsumer;
    //
    //    /**
    //     * When region in segment needs to be loaded to cache, whether to load all regions of the
    // entire
    //     * segment.
    //     */
    ...
    //                new
    // ProducerMergedPartitionFileIndexFlushManager.SegmentMeta[numSubpartitions];
    ...
    //        // all segments with a minBufferIndex less than or equal to this target buffer index
    // may
    ...
    //            long regionOffset = findRegionInSegment(subpartition, bufferIndex, meta,
    // loadToCache);
    //            if (regionOffset != -1) {
    //                return regionOffset;
    //            }
    ...
    //            throws IOException {
    //        // This method will only be called when we want to eliminate a region. We can't let
    // the
    //        // region be reloaded into the cache, otherwise it will lead to an infinite loop.
    //        long oldRegionOffset = findRegion(subpartition, newRegion.getFirstBufferIndex(),
    // false);
    ...
    //        // If the cache can put at least two segments (one for reading and one for writing)
    // for each
    //        // subpartition, it is reasonable to load the entire segment into memory, which can
    // improve
    //        // the cache hit rate. On the contrary, if the cache capacity is small, loading a
    // large
    //        // number of regions will lead to performance degradation,only the target region
    // should be
    //        // loaded.
    ...
    //    }
    //
    //    private void appendRegion(int subpartition, ProducerMergedPartitionFileIndex.Region
    // region)
    //            throws IOException {
    ...
    //    }
    //
    //    private void writeRegionToOffset(long offset, ProducerMergedPartitionFileIndex.Region
    // region)
    //            throws IOException {
    //        channel.position(offset);
    //        ProducerMergedPartitionFileIndex.writeRegionToFile(channel, regionHeaderBuffer,
    // region);
    //    }
    //
    ...
    //        currentSegmentMeta[subpartition] =
    //                new
    // ProducerMergedPartitionFileIndexFlushManager.SegmentMeta(nextSegmentOffset);
    ...
    //    }
    //
    //    private void updateSegment(int subpartition, ProducerMergedPartitionFileIndex.Region
    // region) {
    //        int regionSize = ProducerMergedPartitionFileIndex.Region.REGION_SIZE;
    ...
    //
    //    /**
    //     * Metadata of spilled regions segment. When a segment is finished(i.e. no longer
    // appended), its
    ...
    //        /**
    //         * Minimum buffer index of this segment. It is the smallest bufferIndex(inclusive) in
    // all
    ...
    //
    //        /**
    //         * Maximum buffer index of this segment. It is the largest bufferIndex(inclusive) in
    // all
    //         * regions belong to this segment.
    //         */
    ...
    //                int numSubpartitions,
    //                Path indexFilePath,
    //                BiConsumer<Integer, ProducerMergedPartitionFileIndex.Region>
    // cacheRegionConsumer) {
