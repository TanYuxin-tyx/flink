...
public class ProducerMergedPartitionFileIndexCache {
     ...
     * element is a treeMap contains all in memory {@link ProducerMergedPartitionFileIndex.Region}'s
     * of specific subpartition corresponding to the subscript. The value of this treeMap is a
     * {@link ProducerMergedPartitionFileIndex.Region}, and the key is firstBufferIndex of this
    ...
    /**
     * Close {@link ProducerMergedPartitionFileIndexCache}, this will delete the index file. After
    ...
    private void handleRemove(
            RemovalNotification<ProducerMergedPartitionFileIndexCache.CachedRegionKey, Object>
                    removedEntry) {
        ProducerMergedPartitionFileIndexCache.CachedRegionKey removedKey = removedEntry.getKey();
