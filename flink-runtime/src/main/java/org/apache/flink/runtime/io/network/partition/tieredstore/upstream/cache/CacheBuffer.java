...
/**
 * Data of different channels can be appended to a {@link
 * org.apache.flink.runtime.io.network.partition.DataBuffer} and after the {@link
 * org.apache.flink.runtime.io.network.partition.DataBuffer} is full or finished, the appended data
 * can be copied from it in channel index order.
 *
 * <p>The lifecycle of a {@link org.apache.flink.runtime.io.network.partition.DataBuffer} can be:
 * new, write, [read, reset, write], finish, read, release. There can be multiple [read, reset,
 * write] operations before finish.
 */
