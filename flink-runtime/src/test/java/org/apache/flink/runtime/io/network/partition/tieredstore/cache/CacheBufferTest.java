...
package org.apache.flink.runtime.io.network.partition.tieredstore.cache;
...
import org.apache.flink.runtime.io.network.partition.tieredstore.upstream.cache.CacheBuffer;
import org.apache.flink.runtime.io.network.partition.tieredstore.upstream.cache.HashBasedCacheBuffer;
import org.apache.flink.runtime.io.network.partition.tieredstore.upstream.cache.MemorySegmentAndChannel;
import org.apache.flink.runtime.io.network.partition.tieredstore.upstream.cache.SortBasedCacheBuffer;
...
/** Tests for {@link SortBasedCacheBuffer} and {@link HashBasedCacheBuffer}. */
...
public class CacheBufferTest {
    ...
    public CacheBufferTest(boolean useHashBuffer) {
    ...
    private MemorySegmentAndChannel copyIntoSegment(int bufferSize, CacheBuffer dataBuffer) {
        if (useHashBuffer) {
            return dataBuffer.getNextBuffer(null);
        } else {
