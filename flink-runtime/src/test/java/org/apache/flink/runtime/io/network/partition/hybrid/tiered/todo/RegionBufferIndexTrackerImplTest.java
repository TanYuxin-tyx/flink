...
// import
// org.apache.flink.runtime.io.network.partition.hybrid.tiered.storage.file.PartitionFileIndex.ReadableRegion;
// import
// org.apache.flink.runtime.io.network.partition.hybrid.tiered.storage.file.PartitionFileIndex.SpilledBuffer;
// import
...
//
//    /**
//     * If the buffer index with the corresponding subpartition does not exist in the data index,
// or
...
//
//    /**
//     * If target buffer is already readable, a not null {@link ReadableRegion} starts with the
// given
...
//
//    /**
//     * Verify that the offset of the first buffer of the region is the offset of the target
// buffer.
//     */
