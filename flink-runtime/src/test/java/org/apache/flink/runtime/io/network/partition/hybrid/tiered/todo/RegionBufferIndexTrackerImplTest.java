...
//        partitionFileIndex.writeRegions(createSpilledBuffers(0, Arrays.asList(0, 2)));
...
//        partitionFileIndex.writeRegions(createSpilledBuffers(0, Collections.singletonList(0)));
...
//
//        partitionFileIndex.writeRegions(
